...
<html lang="en">
            ...
            <nav class="navbar navbar-expand-lg">                
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="images/logocingkucing.png" class="navbar-brand-image img-fluid" alt="Tiya Golf Club">
                        <span class="navbar-brand-text">
                            Bonbin
                            <small>Gembira Loka</small>
                        </span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_2">Alamat</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_3">Menu Tiket</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_5">Kritik & Saran</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            ...
                            <div class="custom-btn-group">
                                <a href="#section_2" class="btn custom-btn smoothscroll me-3" style="text-align: left;">ALAMAT</a>
                                <a href="#section_3" class="btn custom-btn smoothscroll me-3">Pembelian Tiket</a>
                            </div>
                        </div>

                        <div class="col-lg-6 col-12">
                            <div class="ratio ratio-16x9">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/7xnHnYz-iJk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                        </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- KIRI (TEKS) -->
      <div class="col-lg-6 col-12">
        <h4>Kebun Binatang Gembira Loka</h4>
        <p>
          Gembira Loka Zoo, Jl. Kebun Raya No.2,<br>
          Rejowinangun, Kec. Kotagede, Kota Yogyakarta,<br>
          Daerah Istimewa Yogyakarta 55171.
        </p>
        <p>Buka setiap hari pukul 08:00 – 16:00 WIB.</p>
      </div>
      ...
      <div class="col-lg-6 col-12">
        <div id="map">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.441419644714!2d110.4092039747749!3d-7.801769094388736!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a583c5b9c8b9%3A0x6e5a9c8b8b8b8b8!2sGembira%20Loka%20Zoo!5e0!3m2!1sid!2sid!4v1700000000000" 
            width="100%" 
            height="450px"
            ...
            <section class="menutiket-section section-padding" id="section_3">
                <div class="container">
                    <div class="row">

                        <div class="col-lg-12 col-12 text-center mx-auto mb-lg-5 mb-4">
                            <h2><span>Menu</span> Tiket</h2>
                        </div>

                        <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                            <h4 class="mb-4 pb-lg-2">Rame lebih Seru!!</h4>
                        ...
                        <h4 class="mb-4 pb-lg-2">Please join us!</h4>
                            <form action="#" method="post" class="custom-form menutiket-form shadow-lg" role="form">
                                <h4 class="text-white btn custom-btn smoothscroll me-3">pembelian tiket</h4>

                                    <div class="form-floating">
                                        <input type="text" nama="nama-panjang" id="nama-panjang" class="form-control" placeholder="Nama Panjang" required="">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" name="jumlah-tiket" id="jumlah-tiket" class="form-control" placeholder="Jumlah Tiket" required="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12">
                            <form action="#" method="post" class="custom-form contact-form" role="form">
                                <h2 class="mb-4 pb-2">Kritik & Saran</h2>

                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-floating">
                                            <input type="text" name="nama-panjang" id="nama-panjang" class="form-control" placeholder="Nama Panjang" required="">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" id="pesan" name="pesan" placeholder="Describe message here"></textarea>
                            ...
                            <div class="contact-info mt-5">
                                <div class="contact-info-item">
                                    <div class="contact-info-body">
                                        ...
                                        <p class="mt-2 mb-1">
                                            <a href="nomor: 082228910262" class="kontak-link">
                                                (+62) 822-2891-0262
                                        ...
                                        <p class="mb-0">
                                            <a href="lutayyanisa@gmail.com" class="contact-link">
                                                lutayyanisa@gmail.com
                                            </a>
                                        </p>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                        <a class="navbar-brand d-flex align-items-center" href="index.html">
                            <img src="logokucing.png" class="navbar-brand-image img-fluid" alt="">
                            <span class="navbar-brand-text">
                                Bonbin
                                <small>Gembira Loka</small>
                            </span>
